...
const S = {
  ...
  menu: {
    ...
    gap: 2,
    // Непрозрачный фон: при живом фоне карточки — полупрозрачное стекло, и
    // меню с тем же фоном просвечивало строками урока под ним.
    background: "var(--menuBg, var(--panel2))",
    border: "1px solid var(--line)",
    borderRadius: 12,
