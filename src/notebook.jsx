...
const styles = {
  ...
  chevron: { background: "none", border: "none", padding: 0, fontSize: 12, color: "var(--mute)", width: 14 },
  count: { fontSize: 11, color: "var(--mute)" },
  remove: { background: "none", border: "none", color: "var(--red)", fontSize: 16, lineHeight: 1, padding: "0 4px" },
  ...
  fileLink: { background: "none", border: "none", padding: 0, fontSize: 12.5, color: "var(--blue)", textDecoration: "underline", textAlign: "left" },
