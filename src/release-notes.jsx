...
const RELEASES = [
  {
    v: "0.5.3",
    date: "12 сентября",
    items: ["Пустые дни в расписании не растягиваются под день с экзаменом."],
    changes: [["Пустой день занимал столько же места, сколько день с экзаменом", "Каждая карточка по своему содержимому"]],
  },
  {
    v: "0.5.2",
    date: "12 сентября",
    ...
    changes: [["Карточки уезжали вправо, сверху светлая полоса", "Всё помещается в экран, тема красит страницу целиком"]],
  },
  {
    v: "0.5.1",
    date: "12 сентября",
