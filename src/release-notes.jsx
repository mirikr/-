...
const RELEASES = [
  {
    v: "0.6.3",
    date: "13 сентября",
    items: ["Дни с экзаменами и олимпиадами обведены в календаре красным."],
    changes: [["Даты экзаменов приходилось искать в расписании", "Красная рамка прямо в календаре дневника"]],
  },
  {
    v: "0.6.2.1",
    date: "12 сентября",
